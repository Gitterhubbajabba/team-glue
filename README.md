...
bashgit clone https://github.com/your-username/team-glue.git
cd team-glue
Backend Setup
...
Start MongoDB:
bashmongod --dbpath=/path/to/data/db
...
Serve the built files (you can use a static server like serve):
